...
\geometry{left=1.5cm, top=1cm, right=1.5cm, bottom=1.5cm, footskip=.25cm} % Configure page margins with geometry
...
\name{Rohit}{Das}
\address{108, Netaji Subhas Avenue, Serampore, Hooghly - 712201, West Bengal, India}
\mobile{(+91) 89102 56472}

\email{rohit.das950@gmail.com}
%\homepage{www.posquit0.com}
\github{mouri11}
\linkedin{rohit-das-10895}
%\skype{skypeid}
...
\position{Budding Developer{\enskip\cdotp\enskip}Teacher} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

%\makecvfooter{\today}{Rohit Das~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
